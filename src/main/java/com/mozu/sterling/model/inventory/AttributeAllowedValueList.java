...
@XmlRootElement(name = "AttributeAllowedValueList")
public class AttributeAllowedValueList {
    ...
    @XmlElement(name = "AttributeAllowedValue")
    protected List<AttributeAllowedValue> attributeAllowedValue;
    ...
    /**
     * Gets the value of the attributeAllowedValue property.
     *
     * <p>
     * This accessor method returns a reference to the live list,
     * not a snapshot. Therefore any modification you make to the
     * returned list will be present inside the JAXB object.
     * This is why there is not a <CODE>set</CODE> method for the attributeAllowedValue property.
     *
     * <p>
     * For example, to add a new item, do as follows:
     * <pre>
     *    getAttributeAllowedValue().add(newItem);
     * </pre>
     *
     *
     * <p>
     * Objects of the following type(s) are allowed in the list
     * {@link AttributeAllowedValue }
     *
     *
     */
    public List<AttributeAllowedValue> getAttributeAllowedValue() {
        if (attributeAllowedValue == null) {
            attributeAllowedValue = new ArrayList<AttributeAllowedValue>();
        }
        return this.attributeAllowedValue;
    }
