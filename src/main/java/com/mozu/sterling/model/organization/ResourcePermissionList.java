...
@XmlRootElement(name = "ResourcePermissionList")
public class ResourcePermissionList {

    @XmlElement(name = "ResourcePermission")
    protected List<ResourcePermission> resourcePermission;
     ...
     * This is why there is not a <CODE>set</CODE> method for the resourcePermission property.
     * 
     * <p>
    ...
    public List<ResourcePermission> getResourcePermission() {
        if (resourcePermission == null) {
            resourcePermission = new ArrayList<ResourcePermission>();
        }
