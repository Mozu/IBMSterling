...
@XmlRootElement(name = "AdditionalDates")
public class AdditionalDates {

    @XmlElement(name = "AdditionalDate")
    protected List<AdditionalDate> additionalDate;
     ...
     * 
     */
    public List<AdditionalDate> getAdditionalDate() {
        if (additionalDate == null) {
            additionalDate = new ArrayList<AdditionalDate>();
        }
