...
@XmlRootElement(name = "ContainerActivities")
public class ContainerActivities {
    ...
    @XmlElement(name = "ContainerActivity")
    protected List<ContainerActivity> containerActivity;
    ...
    /**
     * Gets the value of the containerActivity property.
     * 
     * <p>
     * This accessor method returns a reference to the live list,
     * not a snapshot. Therefore any modification you make to the
     * returned list will be present inside the JAXB object.
     * This is why there is not a <CODE>set</CODE> method for the containerActivity property.
     * 
     * <p>
     * For example, to add a new item, do as follows:
     * <pre>
     *    getContainerActivity().add(newItem);
     * </pre>
     * 
     * 
     * <p>
     * Objects of the following type(s) are allowed in the list
     * {@link ContainerActivity }
     * 
     * 
     */
    public List<ContainerActivity> getContainerActivity() {
        if (containerActivity == null) {
            containerActivity = new ArrayList<ContainerActivity>();
        }
