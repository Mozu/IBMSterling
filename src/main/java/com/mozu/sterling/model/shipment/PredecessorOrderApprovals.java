...
@XmlRootElement(name = "PredecessorOrderApprovals")
public class PredecessorOrderApprovals {

    @XmlAttribute(name = "TotalNumberOfRecords")
    @XmlJavaTypeAdapter(NormalizedStringAdapter.class)
    protected String totalNumberOfRecords;
    @XmlElement(name = "OrderApproval")
    protected List<OrderApproval> orderApproval;
    ...
    /**
     * Gets the value of the orderApproval property.
     * 
     * <p>
     * This accessor method returns a reference to the live list,
     * not a snapshot. Therefore any modification you make to the
     * returned list will be present inside the JAXB object.
     * This is why there is not a <CODE>set</CODE> method for the orderApproval property.
     * 
     * <p>
     * For example, to add a new item, do as follows:
     * <pre>
     *    getOrderApproval().add(newItem);
     * </pre>
     * 
     * 
     * <p>
    ...
    public List<OrderApproval> getOrderApproval() {
        if (orderApproval == null) {
            orderApproval = new ArrayList<OrderApproval>();
        }
