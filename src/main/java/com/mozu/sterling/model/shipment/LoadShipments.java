...
@XmlRootElement(name = "LoadShipments")
public class LoadShipments {
    ...
    @XmlElement(name = "LoadShipment")
    protected List<LoadShipment> loadShipment;
    ...
    /**
     * Gets the value of the loadShipment property.
     * 
     * <p>
     * This accessor method returns a reference to the live list,
     * not a snapshot. Therefore any modification you make to the
     * returned list will be present inside the JAXB object.
     * This is why there is not a <CODE>set</CODE> method for the loadShipment property.
     * 
     * <p>
     * For example, to add a new item, do as follows:
     * <pre>
     *    getLoadShipment().add(newItem);
     * </pre>
     * 
     * 
     * <p>
    ...
    public List<LoadShipment> getLoadShipment() {
        if (loadShipment == null) {
            loadShipment = new ArrayList<LoadShipment>();
        }
        return this.loadShipment;
    }
