...
@XmlRootElement(name = "ShipmentStatusAudits")
public class ShipmentStatusAudits {
    ...
    protected List<ShipmentStatusAudit> shipmentStatusAudit;
    ...
    /**
     * Gets the value of the shipmentStatusAudit property.
     * 
     * <p>
     * This accessor method returns a reference to the live list,
     * not a snapshot. Therefore any modification you make to the
     * returned list will be present inside the JAXB object.
     * This is why there is not a <CODE>set</CODE> method for the shipmentStatusAudit property.
     * 
     * <p>
     * For example, to add a new item, do as follows:
     * <pre>
     *    getShipmentStatusAudit().add(newItem);
     * </pre>
     * 
     * 
     * <p>
     * Objects of the following type(s) are allowed in the list
     * {@link ShipmentStatusAudit }
     * 
     * 
     */
    public List<ShipmentStatusAudit> getShipmentStatusAudit() {
        if (shipmentStatusAudit == null) {
            shipmentStatusAudit = new ArrayList<ShipmentStatusAudit>();
        }
        return this.shipmentStatusAudit;
    }
