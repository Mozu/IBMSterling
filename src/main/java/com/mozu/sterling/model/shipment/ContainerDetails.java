...
@XmlRootElement(name = "ContainerDetails")
public class ContainerDetails {
    ...
    @XmlElement(name = "ContainerDetail")
    protected List<ContainerDetail> containerDetail;
     ...
     * not a snapshot. Therefore any modification you make to the
     * returned list will be present inside the JAXB object.
     * This is why there is not a <CODE>set</CODE> method for the containerDetail property.
     * 
     * <p>
     * For example, to add a new item, do as follows:
     * <pre>
     *    getContainerDetail().add(newItem);
     * </pre>
     * 
     * 
     * <p>
     ...
     * 
     */
    public List<ContainerDetail> getContainerDetail() {
        if (containerDetail == null) {
            containerDetail = new ArrayList<ContainerDetail>();
        }
