...
@XmlType(name = "")
@XmlRootElement(name = "BundleOverallTotals")
public class BundleOverallTotals {

    @XmlAttribute(name = "GrandCharges")
    @XmlJavaTypeAdapter(NormalizedStringAdapter.class)
    protected String grandCharges;
    @XmlAttribute(name = "GrandDiscounts")
    @XmlJavaTypeAdapter(NormalizedStringAdapter.class)
    protected String grandDiscounts;
    ...
    /**
     * Gets the value of the grandDiscounts property.
     * 
     * @return
     *     possible object is
     *     {@link String }
     *     
     */
    public String getGrandDiscounts() {
        return grandDiscounts;
    }

    /**
     * Sets the value of the grandDiscounts property.
     * 
     * @param value
     *     allowed object is
     *     {@link String }
     *     
     */
    public void setGrandDiscounts(String value) {
        this.grandDiscounts = value;
    }
