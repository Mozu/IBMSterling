...
@XmlRootElement(name = "OrderInvoiceList")
public class OrderInvoiceList {
    ...
    @XmlElement(name = "OrderInvoice")
    protected List<OrderInvoice> orderInvoice;
     ...
     * not a snapshot. Therefore any modification you make to the
     * returned list will be present inside the JAXB object.
     * This is why there is not a <CODE>set</CODE> method for the orderInvoice property.
     * 
     * <p>
     * For example, to add a new item, do as follows:
     * <pre>
     *    getOrderInvoice().add(newItem);
     * </pre>
     * 
     * 
     * <p>
     ...
     * 
     */
    public List<OrderInvoice> getOrderInvoice() {
        if (orderInvoice == null) {
            orderInvoice = new ArrayList<OrderInvoice>();
        }
