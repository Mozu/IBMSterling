...
@XmlRootElement(name = "ShipmentTagSerials")
public class ShipmentTagSerials {
    ...
    @XmlElement(name = "ShipmentTagSerial")
    protected List<ShipmentTagSerial> shipmentTagSerial;
    ...
    /**
     * Gets the value of the shipmentTagSerial property.
     * 
     * <p>
     * This accessor method returns a reference to the live list,
     * not a snapshot. Therefore any modification you make to the
     * returned list will be present inside the JAXB object.
     * This is why there is not a <CODE>set</CODE> method for the shipmentTagSerial property.
     * 
     * <p>
     * For example, to add a new item, do as follows:
     * <pre>
     *    getShipmentTagSerial().add(newItem);
     * </pre>
     * 
     * 
     * <p>
     * Objects of the following type(s) are allowed in the list
     * {@link ShipmentTagSerial }
     * 
     * 
     */
    public List<ShipmentTagSerial> getShipmentTagSerial() {
        if (shipmentTagSerial == null) {
            shipmentTagSerial = new ArrayList<ShipmentTagSerial>();
        }
        return this.shipmentTagSerial;
    }
