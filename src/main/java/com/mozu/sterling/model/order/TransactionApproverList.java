...
@XmlRootElement(name = "TransactionApproverList")
public class TransactionApproverList {
    ...
    @XmlElement(name = "TransactionApprover")
    protected List<TransactionApprover> transactionApprover;
    ...
    /**
     * Gets the value of the transactionApprover property.
     * 
     * <p>
     * This accessor method returns a reference to the live list,
     * not a snapshot. Therefore any modification you make to the
     * returned list will be present inside the JAXB object.
     * This is why there is not a <CODE>set</CODE> method for the transactionApprover property.
     * 
     * <p>
     * For example, to add a new item, do as follows:
     * <pre>
     *    getTransactionApprover().add(newItem);
     * </pre>
     * 
     * 
     * <p>
     * Objects of the following type(s) are allowed in the list
     * {@link TransactionApprover }
     * 
     * 
     */
    public List<TransactionApprover> getTransactionApprover() {
        if (transactionApprover == null) {
            transactionApprover = new ArrayList<TransactionApprover>();
        }
